...
<!-- SJ: love the figure... is it supposed to be interactive? if not, confused what the tabs "By electoral votes" "By winner" are saying/trying to explain -->
...
<!-- SJ: unsure of what you mean by "Using our knowledge of PDFs? Maybe explain this one a little more? -->
...
<!-- SJ: Not sure if this is done in the tutorials, but would be helpful to have a but more information/explanation about what is going on in this code chunk above! -->
...
<!-- SJ: Love this Takeaway section! Its an important recap for the reader... maybe put "Takeaway" in bold or something to highlight this sections significance? -->
...
<!-- SJ: Appreciate how relevant this section is to current events! -->
...
<!-- SJ: For the notes in the margin... for consistency purposes it might be helpful to mention under "Negative" and "Positive" that Positive is if the test result indicates they have the disease AND they do in fact have the disease, same concept applies for the Negative tab the test results indicate they don't have the disease AND it is with a patient that truly doesn't -->
...
<!-- SJ: Is it possible to enlarge the first tree diagram a bit? The numbers are so small/a little hard to read! -->
...
<!-- SJ: This section in line 943 is confusing to me... Could you possibly explain a little further what is meant when you say "how likely is it to get a sample of 20 with a sample proportion of .4 for various population proportions?" I understand what your trying to say but maybe rearrange that wording. Maybe say "That is, if the NEW population proportion is 500/1000" and then maybe explain again what 500/1000 means for the population ie: half of the people at school say they are interested...  -->
...
<!-- SJ: This makes sense but definitely would be helpful to offer a bit of explanation about why choose 20 students repeatedly, and why is that helpful ie: how does that fit into the model we are trying to create -->
...
<!-- SJ: also maybe state if this may or may not consist of overlap? As in possibly interviewing the same student twice -->
...
<!-- SJ: would be helpful for the reader if instead of saying "did this" in code chunk 1000, you wrote out what you mean by this because its getting a little jumbled as to what you are referring to -->
...
<!-- SJ: is there a possibility you could label each row? I know it's stated that each row resembles a high school but for clarity it would be nice to indicate which row associates with which high school based on their population proportion for who values statistics -->
...
<!-- SJ: this animation is extremely helpful... more of these would be great! -->
...
<!-- SJ: this paragraph is very well written and clear. Helps so much with understanding! -->
...
<!-- SJ: unless it is previously explained in the book it would be helpful to provide a short sentence of an explanation of p-value of a hypothesis test... some students take this course before they take stats -->
...
<!-- SJ: This whole section might need a little flushing out? Maybe provide a quick example of what your talking about with the relationship between .04 and .06 not being so significant and an example of not choosing X over Y? -->

## Posterior Predictions (Advanced)

Looking at the marginal distributions from the Bayes scatterplots shows us the posterior distribution of the data, conditioning on the model, and of the model, conditioning on the data. In other words, if the model is true, this is what we believe about the distribution of the data, both the data that we have already seen and about the data we will see in the future, assuming that the model is true.

<!-- SJ: fixed minor spelling here -->
...
<!-- SJ: not sure if using a coin is the most successful use of an example just because the reader intrinsically assumes that coins toss 50/50 with .5 probability so it is hard to look around that for this example -->

To construct posterior predictions, we do the same sampling procedure as with the Bayes scatterplots, while averaging over the rest of possible values for $p$, weighted by their relative likelihood. Recall the analysis above:
